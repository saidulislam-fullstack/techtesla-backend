...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ContactPerson::create([
            ...
            'visiting_card_front' => $request->hasFile('visiting_card_front') ? $request->file('visiting_card_front')->store('public/visiting_cards') : null,
            'visiting_card_back' => $request->hasFile('visiting_card_back') ? $request->file('visiting_card_back')->store('public/visiting_cards') : null,
        ]);
