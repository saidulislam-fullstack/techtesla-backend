                            ...
                            let row = `
                                <tr>
                                    <td>
                                        ...
                                        <input type="hidden" name="items[currency_id][]" value="${item.currency_id}">
                                        <input type="hidden" name="items[supplier_price][]" value="${item.price}">
                                    </td>
                                    <td>
                                        ${item.product.code}
                                    ...
                                    <td class="">${item.price} ${item.currency.code}</td>
