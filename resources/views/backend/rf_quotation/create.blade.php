                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="rfq_date">{{ trans('file.Date') }}</label><span class="required">
                                            *</span>
                                        <input type="date" name="date" id="rfq_date" class="form-control" required />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="customer_id" name="customer_id" class="selectpicker form-control"
                                            ...
                                            <option value="{{ $customer->id }}">
                                                {{$customer->name . ' (' . ($customer->contactPersons->first()?->phone
                                                ?? '[Add Phone No]') . ')'}}
                                            </option>
                                            @endforeach
                                        </select>
        ...
        $(document).on('click', '.product-item', function() {
            ...
            if (existingRow.length > 0) {
                ...
                let row = '<tr>' +
                    ...
                    '"><input type="hidden" name="product_id[]" value="' + productId + '" /></td><td>' + productCode + '</td>' +
