    ...
    <script type="text/javascript">
        ...
        function quotationDetails(quotation) {
            ...
            var htmltext = '<strong>{{ trans('file.Date') }}: </strong>' + quotation[0] +
                ...
                '<br><strong>{{ trans('file.Status') }}: </strong>' + quotation[2] + '<br>';
            if (quotation[25])
                htmltext += '<strong>{{ trans('file.Attach Document') }}: </strong><a href="documents/quotation/' +
                quotation[25] + '">Download</a><br>';
