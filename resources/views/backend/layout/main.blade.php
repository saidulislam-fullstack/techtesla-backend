...
<head>
    ...
    @if (!config('database.connections.saleprosaas_landlord'))
        ...
        <link rel="preload" href="{{ asset('vendor/bootstrap-toggle/css/bootstrap-toggle.min.css') }}" as="style"
            onload="this.onload=null;this.rel='stylesheet'">
        <noscript>
            <link href="{{ asset('vendor/bootstrap-toggle/css/bootstrap-toggle.min.css') }}" rel="stylesheet">
        </noscript>
        <link rel="preload" href="{{ asset('vendor/bootstrap/css/bootstrap-datepicker.min.css') }}" as="style"
            onload="this.onload=null;this.rel='stylesheet'">
        <link rel="preload" href="{{ asset('vendor/jquery-timepicker/jquery.timepicker.min.css') }}" as="style"
            onload="this.onload=null;this.rel='stylesheet'">
        <noscript>
            <link href="{{ asset('vendor/jquery-timepicker/jquery.timepicker.min.css') }}" rel="stylesheet">
        </noscript>
        <link rel="preload" href="{{ asset('vendor/bootstrap/css/awesome-bootstrap-checkbox.css') }}" as="style"
            onload="this.onload=null;this.rel='stylesheet'">
        <noscript>
            <link href="{{ asset('vendor/bootstrap/css/awesome-bootstrap-checkbox.css') }}" rel="stylesheet">
        </noscript>
        ...
        <!-- Font Awesome CSS-->
        <link rel="preload" href="{{ asset('vendor/font-awesome/css/font-awesome.min.css') }}" as="style"
            onload="this.onload=null;this.rel='stylesheet'">
        <noscript>
        ...
        <link rel="preload" href="{{ asset('vendor/dripicons/webfont.css') }}" as="style"
            onload="this.onload=null;this.rel='stylesheet'">
        <noscript>
            <link href="{{ asset('vendor/dripicons/webfont.css') }}" rel="stylesheet">
        </noscript>

        <!-- jQuery Circle-->
        <link rel="preload" href="{{ asset('css/grasp_mobile_progress_circle-1.0.0.min.css') }}" as="style"
            onload="this.onload=null;this.rel='stylesheet'">
        <noscript>
            <link href="{{ asset('css/grasp_mobile_progress_circle-1.0.0.min.css') }}" rel="stylesheet">
        </noscript>
        <!-- Custom Scrollbar-->
        <link rel="preload" href="{{ asset('vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.css') }}"
            as="style" onload="this.onload=null;this.rel='stylesheet'">
        <noscript>
            <link href="{{ asset('vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.css') }}"
                rel="stylesheet">
        </noscript>
        ...
        @if (Route::current()->getName() != '/')
            ...
            <link rel="preload" href="{{ asset('vendor/datatable/dataTables.bootstrap4.min.css') }}" as="style"
                onload="this.onload=null;this.rel='stylesheet'">
            <noscript>
        ...
        @if (Config::get('app.locale') == 'ar' || $general_setting->is_rtl)
            <!-- RTL css -->
            <link rel="stylesheet" href="{{ asset('vendor/bootstrap/css/bootstrap-rtl.min.css') }}" type="text/css">
            <link rel="stylesheet" href="{{ asset('css/custom-rtl.css') }}" type="text/css" id="custom-style">
        @endif
    @else
        <link rel="icon" type="image/png" href="{{ url('../../logo', $general_setting->site_logo) }}" />
        <title>{{ $general_setting->site_title }}</title>
        ...
        <!-- Bootstrap CSS-->
        <link rel="stylesheet" href="{{ asset('../../vendor/bootstrap/css/bootstrap.min.css') }}" type="text/css">
        <link rel="preload" href="{{ asset('../../vendor/bootstrap-toggle/css/bootstrap-toggle.min.css') }}"
            as="style" onload="this.onload=null;this.rel='stylesheet'">
        <noscript>
            <link href="{{ asset('../../vendor/bootstrap-toggle/css/bootstrap-toggle.min.css') }}" rel="stylesheet">
        </noscript>
        <link rel="preload" href="{{ asset('../../vendor/bootstrap/css/bootstrap-datepicker.min.css') }}"
            as="style" onload="this.onload=null;this.rel='stylesheet'">
        <noscript>
            <link href="{{ asset('../../vendor/bootstrap/css/bootstrap-datepicker.min.css') }}" rel="stylesheet">
        </noscript>
        <link rel="preload" href="{{ asset('../../vendor/jquery-timepicker/jquery.timepicker.min.css') }}"
            as="style" onload="this.onload=null;this.rel='stylesheet'">
        <noscript>
            <link href="{{ asset('../../vendor/jquery-timepicker/jquery.timepicker.min.css') }}" rel="stylesheet">
        </noscript>
        <link rel="preload" href="{{ asset('../../vendor/bootstrap/css/awesome-bootstrap-checkbox.css') }}"
            as="style" onload="this.onload=null;this.rel='stylesheet'">
        <noscript>
            <link href="{{ asset('../../vendor/bootstrap/css/awesome-bootstrap-checkbox.css') }}" rel="stylesheet">
        </noscript>
        <link rel="preload" href="{{ asset('../../vendor/bootstrap/css/bootstrap-select.min.css') }}"
            as="style" onload="this.onload=null;this.rel='stylesheet'">
        <noscript>
            <link href="{{ asset('../../vendor/bootstrap/css/bootstrap-select.min.css') }}" rel="stylesheet">
        </noscript>
        ...
        <!-- jQuery Circle-->
        <link rel="preload" href="{{ asset('../../css/grasp_mobile_progress_circle-1.0.0.min.css') }}"
            as="style" onload="this.onload=null;this.rel='stylesheet'">
        <noscript>
            <link href="{{ asset('../../css/grasp_mobile_progress_circle-1.0.0.min.css') }}" rel="stylesheet">
        </noscript>
        ...
        @if (Route::current()->getName() != '/')
            <!-- date range stylesheet-->
            <link rel="preload" href="{{ asset('../../vendor/daterange/css/daterangepicker.min.css') }}"
                as="style" onload="this.onload=null;this.rel='stylesheet'">
            <noscript>
                <link href="{{ asset('../../vendor/daterange/css/daterangepicker.min.css') }}" rel="stylesheet">
            </noscript>
            <!-- table sorter stylesheet-->
            <link rel="preload" href="{{ asset('../../vendor/datatable/dataTables.bootstrap4.min.css') }}"
                as="style" onload="this.onload=null;this.rel='stylesheet'">
            <noscript>
                <link href="{{ asset('../../vendor/datatable/dataTables.bootstrap4.min.css') }}" rel="stylesheet">
            </noscript>
...
<body
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                @php
                                    $category_permission_active = $role_has_permissions_list
                                        ->where('name', 'category')
                                        ->first();
                                @endphp
                                ...
                                @endif
                                @php
                                    $sale_add_permission_active = $role_has_permissions_list
                                ...
                                @endif
                                @php
                                    $expense_add_permission_active = $role_has_permissions_list
                                ...
                                @endif
                                @php
                                    $quotation_add_permission_active = $role_has_permissions_list
                                ...
                                @endif
                                @php
                                    $transfer_add_permission_active = $role_has_permissions_list
                                ...
                                @endif
                                @php
                                    $return_add_permission_active = $role_has_permissions_list
                                        ->where('name', 'returns-add')
                                        ->first();
                                @endphp
                                ...
                                @endif
                                @php
                                    $purchase_return_add_permission_active = $role_has_permissions_list
                                        ->where('name', 'purchase-return-add')
                                        ->first();
                                @endphp
                                ...
                                @endif
                                @php
                                    $user_add_permission_active = $role_has_permissions_list
                                ...
                                @endif
                                @php
                                    $customer_add_permission_active = $role_has_permissions_list
                                ...
                                @endif
                                @php
                                    $biller_add_permission_active = $role_has_permissions_list
                                ...
                                @endif
                                @php
                                    $supplier_add_permission_active = $role_has_permissions_list
                        ...
                        @php
                            $empty_database_permission_active = $role_has_permissions_list
                            ...
                            $product_qty_alert_active = $role_has_permissions_list
                                ->where('name', 'product-qty-alert')
                                ->first();

                            $general_setting_permission_active = $role_has_permissions_list
                        ...
                        <li class="nav-item">
                            <a id="btnFullscreen" data-toggle="tooltip" title="{{ trans('file.Full Screen') }}">
                                <i class="dripicons-expand"></i>
                            </a>
                        </li>
                        @if (\Auth::user()->role_id <= 2)
                            <li class="nav-item"><a href="{{ route('cashRegister.index') }}" data-toggle="tooltip"
                                    title="{{ trans('file.Cash Register List') }}">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <p>&copy; {{ $general_setting->site_title }} | {{ trans('file.Developed') }}
                            {{ trans('file.By') }} <span
                                class="external">{{ $general_setting->developed_by }}</span> | V
                            {{ env('VERSION') }}</p>
                    </div>
                </div>
            </div>
    ...
    @if (!config('database.connections.saleprosaas_landlord'))
        ...
        @if (Config::get('app.locale') == 'ar' || $general_setting->is_rtl)
            <script type="text/javascript" src="{{ asset('js/front_rtl.js') }}"></script>
        @else
    ...
    <script type="text/javascript">
        ...
        $('#switch-theme').click(function() {
            if (theme == 'light') {
                theme = 'dark';
                var url = @json(route('switchTheme', 'dark'));
                $('body').addClass('dark-mode');
                $('#switch-theme i').addClass('dripicons-brightness-low');
            } else {
                theme = 'light';
                var url = @json(route('switchTheme', 'light'));
                $('body').removeClass('dark-mode');
                $('#switch-theme i').addClass('dripicons-brightness-max');
            }
