<ul id="side-main-menu" class="side-menu list-unstyled">
        ...
        <li>
            ...
            <ul id="quotation" class="collapse list-unstyled ">
                ...
                <li id="rf-quotation-list-menu">
                    <a href="{{ route('rf-quotation.index') }}">RFQ List</a>
                </li>
                @php
    ...
    {{-- @if (!config('database.connections.saleprosaas_landlord'))
        <li><a href="#addons" aria-expanded="false" data-toggle="collapse"> <i
            ...
            <ul id="addons" class="collapse list-unstyled">
                <li id="addon-list"><a href="{{ url('addon-list') }}">
                        <span>{{ trans('file.Addon List') }}</span></a></li>
    ...
    <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i
        ...
        <ul id="setting" class="collapse list-unstyled ">
            @php
                $all_notification_permission_active = $role_has_permissions_list
                    ->where('name', 'all_notification')
                    ->first();

                $send_notification_permission_active = $role_has_permissions_list
                    ->where('name', 'send_notification')
                    ->first();

                $warehouse_permission_active = $role_has_permissions_list->where('name', 'warehouse')->first();

                $customer_group_permission_active = $role_has_permissions_list
                ...
                $backup_database_permission_active = $role_has_permissions_list
                ...
                $reward_point_setting_permission_active = $role_has_permissions_list
